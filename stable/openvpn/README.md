...
**NOTE:** This was originally copied from https://github.com/kubernetes/charts/tree/master/stable/openvpn . The rest of the readme is mostly still in tact from there but we support using LDAP as an auth backend in this repo. Also, the image we use to back this repo is centos 7 not alpine.

## TODOS

* k8s secrets should possibly get made by the chart 
